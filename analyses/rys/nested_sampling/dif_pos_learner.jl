...
joint_logZ=rys_logZ+sib_logZ
evratio=joint_logZ-combined_logZ
sig=evratio.val/evratio.err

println("$(round(sib_logZ,digits=3)) & $(round(rys_logZ,digits=3)) & {\\bf $(round(joint_logZ,digits=3))} & $(round(combined_logZ,digits=3)) &  $(round(evratio,digits=3)) &  $(round(sig,digits=1)) \\\\ \\hline")
