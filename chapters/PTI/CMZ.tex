...
\begin{figure}[!h]
    \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{cmz/a10dvMAP.png}}    
...
\subsection{Cumulative thymidine labelling supports GMC-NS model predictions}
