...
% \autoref{chap:SMME} was produced as the result of an effort to understand and extend the SMME models presented by Harris' group. Having been mainly occupied at the bench with my own experiments whilst the papers were published, I had (rather na\"{i}vely) surmised from the warm reception of the papers that the heavy theoretical lifting had probably been done, and that my task would mainly be to adapt the models to the postembryonic context. I found that I could not do this, and could not understand why; my training was mostly centered around the conventional pharmacological sense of ``mechanism'', which, despite Harris' interventional methodology, is certainly not the type of explanation he is proposing. That is, the SMME does not consist in a picture-drawing of receptors and effectors arranged in a system of ordinary differential equations, or the like. Nor does it consist of a traditional Simple Stochastic Model, which any stem cell biologist routinely encounters and accepts as a basic conceptual tool. 
...
% I proceed here with a broad suggestion taken from the statistical theory of model selection. As Burnham and Anderson state in the introduction to their helpful text ``Model Selection and Multimodel Inference":
