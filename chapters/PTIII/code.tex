...
\subsection{\protect\path{/src/utilities/ensemble_utilities.jl}}
\inputminted[breaklines, mathescape, linenos,   numbersep=5pt, frame=lines, framesep=2mm]{julia}{/srv/git/GMC_NS/src/utilities/ensemble_utilities.jl}
...
\label{CMZNScode}
\subsection{\protect\path{/src/BioSimpleStochastic.jl}}
\inputminted[breaklines, mathescape, linenos,   numbersep=5pt, frame=lines, framesep=2mm]{julia}{/srv/git/CMZNicheSims/src/BioSimpleStochastic.jl}
